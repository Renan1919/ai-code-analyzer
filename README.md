...
This is a front-end project built with React and Vite that leverages the Google Gemini API to analyze code snippets, offering insights and explanations[cite: 1].

## ✨ Features

* A clean interface for pasting or typing code.
* Real-time code analysis using Google's generative AI.
...
* **React** (v19.1.0) 
* **Vite** (v7.0.4) 
* **Google Generative AI SDK** (v0.24.1) [cite: 1]
